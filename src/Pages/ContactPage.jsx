      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div  class="max-w-[570px] mb-12  lg:mb-0">
               <span  class="block mb-4 text-base text-right  font-semibold">
               أتصل بنا
               </span>
               <h2 
                  class="
...
تواصل معنا عبرة مواقع التواصل               </h2>
               <p  class="text-base text-right text-body-color leading-relaxed mb-9 " >
               ...
               <div  class="flex  mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1 text-right" >موقعنا</h4>
                     <p  class="text-base text-body-color text-right">
                        باب الشرجي سوق البدلات العسكرية ساحة الطيران
                     </p>
                  </div>
               </div>
               <div class=" text-right flex mb-8 max-w-[370px] w-full">
                  <div
                     class="
                     max-w-[60px]
                     sm:max-w-[70px]
                  ...
                  <div class="w-full text-right">
                     <h4 class="font-bold text-dark text-xl mb-1">ارقام الهاتف</h4>
                     <p class="text-base text-body-color">(+964)7737122445</p>
                     <p class="text-base text-body-color">(+964)7837122445</p>
