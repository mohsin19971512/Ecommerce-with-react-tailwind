...
<section className={activeNav ? "bg-white py-20 lg:py-[120px] mt-[450px] overflow-hidden relative z-10" : "bg-white py-20 lg:py-[120px] overflow-hidden relative z-10"}>
   <div className="container">
      <div className="flex flex-wrap lg:justify-between -mx-4">
         <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div  className="max-w-[570px] mb-12  lg:mb-0">
               <span  className="block mb-4 text-base text-right  font-semibold">
               أتصل بنا
               </span>
               <h2 
                  className="
                  ...
                  "
                  >
تواصل معنا عبرة مواقع التواصل               </h2>
               <p  className="text-base text-right text-body-color leading-relaxed mb-9 " >
                  بامكانكم مراسلتنا اذا حدث اي خطاء او كان لديكم اي استفسار عن طريق الفيس بوك او الانستا كرام او رقم الهاتف في حال وددتم مشاركتنا اي شيء او فكرة 
               </p>
               <div  className="flex  mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                     <h4 className="font-bold text-dark text-xl mb-1 text-right" >موقعنا</h4>
                     <p  className="text-base text-body-color text-right">
                        باب الشرجي سوق البدلات العسكرية ساحة الطيران
                     </p>
                  </div>
               </div>
               <div className=" text-right flex mb-8 max-w-[370px] w-full">
                  <div
                     className="
                     max-w-[60px]
                     sm:max-w-[70px]
                  ...
                  <div className="w-full text-right">
                     <h4 className="font-bold text-dark text-xl mb-1">ارقام الهاتف</h4>
                     <p className="text-base text-body-color">(+964)7737122445</p>
                     <p className="text-base text-body-color">(+964)7837122445</p>
