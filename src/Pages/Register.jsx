...
export default class Register extends Component {
  ...
  //style
  inputStyle =
    "border-[2px] border-silver rounded-lg outline-green-900 p-2 focus:border-green-900 ease-linear duration-200 min-w-0";

  buttonStyle = "mt-5 flex justify-center bg-green-900 text-white font-medium rounded-md p-2 ease-linear duration-200"
  activeButtonStyle = ' hover:bg-white hover:text-black	 hover:scale-[1.0.5] hover:border-[2px] hover:shadow-md hover:border-green-900 cursor-pointer'
